...
$(document).ready(function() {
	$("#data").load('modul/lap_pembelian/tampil_data.php');
	...
	$("#cari").click(function() {
		...
		if (kode2.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lap_pembelian/tampil_data.php",
	...
	$("#cetak").click(function() {
		var kode1	= $("#kode1").val();
		var kode2	= $("#kode2").val();
		window.location.href='modul/laporan/lap_pembelian.php?kode1='+kode1+'&kode2='+kode2;
		/*
	   	$.ajax({
			type	: "GET",
...
echo "<div id='filter' align='center'>
	<fieldset>
		...
		<table width='100%'>
			<tr>
				<td width='10%'>Tanggal Beli</td>
				<td width='2%'>:</td>
				<td ><select nama='kode1' id='kode1'>
				<option value=''>-Pilih Tanggal Beli-</option>";
				$query	= "SELECT * FROM pembelian ORDER BY tgl_beli";
				$sql	= mysql_query($query);
				while($r_data=mysql_fetch_array($sql)){
					echo "<option value='".$r_data['tgl_beli']."'>".$r_data['tgl_beli']." - ".$r_data['nama_barang']."</option>";
				}
				echo "</select>
				</td>
