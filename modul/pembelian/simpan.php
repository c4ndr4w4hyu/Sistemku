...
$sql = mysql_query("SELECT kode_beli,tgl_beli,kode_supplier,kode_barang,nama_barang,jumlah_beli,harga_beli
				   FROM $table 
...
if ($row>0){
	...
	$input = "INSERT INTO $table (kode_beli,tgl_beli,kode_supplier,kode_barang,nama_barang,jumlah_beli,harga_beli)
