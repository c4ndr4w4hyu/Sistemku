...
$sql = mysql_query("SELECT kode_jual,tgl_jual,kode_barang,nama_barang,jumlah_jual,harga_jual,username
				   FROM $table 
...
if ($row>0){
	...
	$input = "INSERT INTO $table (kode_jual,tgl_jual,kode_barang,nama_barang,jumlah_jual,harga_jual,username)
				VALUES('$kode','$tgl','$kode_brg','$nama_brg','$jumlah','$harga','$user')";
	mysql_query($input);
